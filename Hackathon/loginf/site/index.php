  ...
  <body>
    <nav class="navbar">
      <div class="navbar__container">
        <a href="#home" id="navbar__logo">Financeiva</a>
    ...
    <div class="main" id="">
      <div class="main__container">
        <div class="main__content">
          ...
          <p>Android & iOS</p>
          <button class="main__btn" onclick="window.location.href='../comingSoonPage/index.html'"><a href="">Try Now</a></button>
        </div>
        <div class="main__img--container">
